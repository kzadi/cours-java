package dev.jzadi.formation.javase.classes.test;

import dev.jzadi.formation.javase.classes.Compte;
...
*/
        ...
        */
        ...
        Personne francois = new Personne("François", 34);
        Personne gayet = new Personne("Gayet", 33);
